...
@Schema()
@Introspected
data class UserAnalysisHourDTO(
    ...
    @field:Schema(description = "小时[12]",example = "1",required=true)
    var  hours:Int?=null,
	

    @field:Schema(description = "统计数字[1]",type="string",example = "1339468674200637453",required=true)
